...
export default function Precos() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "Absolutamente. Utilizamos criptografia de nível bancário e fazemos backups automáticos diários dos seus dados."
    },
    {
    ...
    },
    {
      ...
      answer: "Sim, todos os planos incluem suporte. Planos superiores têm suporte prioritário e 24/7."
    }
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto">
            <h1 className="text-5xl lg:text-6xl font-bold text-gray-900 mb-6 leading-tight" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>
              Planos Que <span className="bg-gradient-to-r from-emerald-600 to-green-600 bg-clip-text text-transparent">Cabem</span> No Seu Bolso
            </h1>
              ...
              >
                ...
                <div className="text-center">
                  <div className={`w-16 h-16 rounded-2xl flex items-center justify-center mx-auto mb-6 ${
                    plan.popular ? 'bg-white/20' : 'bg-gradient-to-br from-emerald-600 to-green-600'
                  }`}>
                  ...
                  <div className="mb-6">
                    ...
                    {plan.originalPrice && (
                      <div className={`text-sm mt-1 ${plan.popular ? 'text-emerald-200' : 'text-gray-500'}`}>
                        <span className="line-through">R${plan.originalPrice}/mês</span>
                      </div>
                    )}
                    <div className={`text-sm mt-2 ${plan.popular ? 'text-emerald-100' : 'text-gray-600'}`}>
                      {plan.limit}
                    </div>
                  </div>
                  
                  <button className={`w-full py-4 rounded-xl font-semibold text-lg transition-all duration-200 mb-8 ${
                    plan.popular
