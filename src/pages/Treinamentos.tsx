...
export default function Treinamentos() {
  ...
  const benefits = [
    ...
    },
    {
      ...
      description:
        'Escolha entre cursos online, presenciais ou híbridos conforme sua disponibilidade',
    },
    {
      icon: Calendar,
  ...
  const testimonials = [
    {
      ...
      content:
        'O treinamento avançado me ajudou a aumentar a eficiência da IATF em 35%. Recomendo a todos os colegas.',
      rating: 5,
    ...
    },
    {
      ...
      content:
        'Certificação completa que transformou nossa gestão. A equipe toda passou pelo treinamento.',
      rating: 5,
    ...
    },
    {
      ...
      content:
        'Curso online prático e objetivo. Em poucas horas já estava usando o sistema com confiança.',
      rating: 5,
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 mb-6">
                ...
                {selectedTraining
                  ...
                  : 'receber mais informações sobre nossos treinamentos'}
                :
              </p>
              ...
              <form className="space-y-4">
                ...
                >
                  {selectedTraining ? 'Confirmar Inscrição' : 'Receber Informações'}{' '}
